...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_channels, num_classes, zero_init_residual=False,
        ...
        self.conv1 = nn.Conv3d(in_channels, self.inplanes, kernel_size=3, stride=2, padding=1, bias=False)
