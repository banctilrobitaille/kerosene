...
from ignite.metrics import Accuracy, Average, Precision, MeanAbsoluteError, MeanPairwiseDistance, MeanSquaredError, \
    Recall, RootMeanSquaredError, TopKCategoricalAccuracy, Metric, ConfusionMatrix, MetricsLambda, \
    GeometricAverage, IoU
...
class IoU_(Metric):
    ...
    def __init__(self, num_classes: int, reduction: Union[None, str] = "mean", average: str = None,
        ...
        self._metric = self.create_iou_metric(self._cm)
        super(IoU_, self).__init__(output_transform=output_transform)
