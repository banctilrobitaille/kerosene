...
class ModelTrainerFactoryTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        torch.save({
            ...
            "optimizer_state_dict": self._model_trainer[0].optimizer_state
    ...
    def test_should_reload_state_dict_and_have_same_state(self):
        ...
        assert_that(model_trainer[0].optimizer.state_dict()["state"],
                    is_(self._optim.state_dict()["state"]))
        assert_that(model_trainer[0].optimizer.state_dict()["param_groups"][0],
